...
//           <Route
//             path="/courses"
//             element={isAuthenticated ? <Courses user={user} onLogout={handleLogout} /> : <Navigate to="/login" />}
//           />
//           <Route
//             path="/students"
//             element={isAuthenticated ? <Students user={user} onLogout={handleLogout} /> : <Navigate to="/login" />}
//           />
//           <Route
//             path="/reports"
...
//           <Route
//             path="/settings"
//             element={isAuthenticated ? <Settings user={user} onLogout={handleLogout} /> : <Navigate to="/login" />}
//           />
//           <Route
//             path="/add-course-request"
//             element={
//               isAuthenticated ? <AddCourseRequest user={user} onLogout={handleLogout} /> : <Navigate to="/login" />
//             }
